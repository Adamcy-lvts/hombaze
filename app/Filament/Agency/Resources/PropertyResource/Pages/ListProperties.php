...
class ListProperties extends ListRecords
{
        ...
        return [
            ...
            Actions\Action::make('quick_create')
                ...
                ->action(function (array $data) {
                    ...
                    $property = Property::create($this->prepareQuickCreateData($data, $agency?->id));
    ...
    private function prepareQuickCreateData(array $data, ?int $agencyId): array
    {
        ...
        if ($agentProfile && $agentProfile->agency_id === $agencyId) {
