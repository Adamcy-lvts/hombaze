...
use App\Filament\Agent\Resources\SalesAgreementResource\Pages\CreateSalesAgreement;
use App\Filament\Agent\Resources\SalesAgreementResource\Pages\EditSalesAgreement;
use App\Filament\Agent\Resources\SalesAgreementResource\Pages\ListSalesAgreements;
use App\Filament\Agent\Resources\SalesAgreementResource\Pages\ViewSalesAgreement;
                            ...
                            ->schema([
                                ...
                                Actions::make([
                                    Action::make('manageTemplates')
                                        ...
                                        ->color('gray')
                                        ->url(route('filament.agent.resources.sales-agreement-templates.index'))
                                        ->openUrlInNewTab(),
                                ])
                                    ->alignEnd(),
                            ]),
