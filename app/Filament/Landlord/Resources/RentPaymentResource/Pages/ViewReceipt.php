...
class ViewReceipt extends Page
{
    ...
    protected static string $view = 'filament.landlord.resources.rent-payment-resource.pages.view-receipt';
    ...
    public function downloadPdf()
    {
        try {
            ...
            try {
                ...
                $pdf = Pdf::view('filament.landlord.pages.rent-receipt-pdf', [
    ...
    public function downloadPng()
    {
        try {
            ...
            ';
                ...
                $html = view('filament.landlord.pages.rent-receipt-pdf', [
                    'receipt' => $this->receipt,
                    'qrCode' => $qrCodeSvg,
                    'amountInWords' => $this->amountInWords,
                    'companyLogo' => $companyLogo,
