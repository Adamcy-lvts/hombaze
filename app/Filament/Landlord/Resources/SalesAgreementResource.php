...
use App\Filament\Landlord\Resources\SalesAgreementResource\Pages\CreateSalesAgreement;
use App\Filament\Landlord\Resources\SalesAgreementResource\Pages\EditSalesAgreement;
use App\Filament\Landlord\Resources\SalesAgreementResource\Pages\ListSalesAgreements;
use App\Filament\Landlord\Resources\SalesAgreementResource\Pages\ViewSalesAgreement;
                            ...
                            ->schema([
                                ...
                                Actions::make([
                                    Action::make('manageTemplates')
                                        ...
                                        ->color('gray')
                                        ->url(route('filament.landlord.resources.sales-agreement-templates.index'))
                                        ->openUrlInNewTab(),
                                ])
                                    ->alignEnd(),
                            ]),
