...
class CreateFreeReceipt extends Page implements HasForms
{
    ...
    protected string $view = 'filament.property-owner.pages.create-free-receipt';
    ...
    public function viewReceipt(): void
    {
        if ($this->createdReceipt) {
            $this->redirect(route('filament.property-owner.resources.rent-payments.view-receipt', $this->createdReceipt));
        }
    }
