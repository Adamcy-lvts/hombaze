...
class EditProperty extends Page
{
    ...
    protected string $view = 'filament.property-owner.pages.edit-property';
    ...
    {
        if (!$this->record) {
             $this->redirect(route('filament.property-owner.pages.my-properties'));
             return;
        }
    ...
    public function update()
    {
        ...
        return redirect()->route('filament.property-owner.pages.my-properties');
    }
