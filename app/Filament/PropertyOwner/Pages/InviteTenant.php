...
class InviteTenant extends Page
{
    ...
    protected string $view = 'filament.property-owner.pages.invite-tenant';
    ...
    public function generateLink()
    {
        ...
        // Correct format phone number if needed (basic normalization)
        // ...
    ...
    public function getPropertiesProperty()
    {
        ...
        $ownerId = $propertyOwner ? $propertyOwner->id : Auth::id();
        ...
        // Return properties belonging to owner, excluding those with pending invites
