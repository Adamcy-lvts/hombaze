...
class MyProperties extends Page implements HasActions, HasForms
{
    ...
    protected string $view = 'filament.property-owner.pages.my-properties';
    ...
    public function loadProperties()
    {
        ...
        if ($owner) {
            $this->properties = Property::where('owner_id', $owner->id)
        ...
        return Action::make('delete')
            ...
            ->action(function (array $arguments) {
                $property = Property::where('id', $arguments['record'])
                    ->where('owner_id', PropertyOwner::where('user_id', Auth::id())->value('id'))
                    ->first();
