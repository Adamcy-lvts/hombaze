...
class ProfileCompletion extends Page implements HasForms, HasActions
{
    ...
    protected string $view = 'filament.property-owner.pages.profile-completion';
    ...
    public function mount(): void
    {
        ...
        $this->form->fill([
            ...
            'nin_number' => $propertyOwner?->nin_number ?? '',
        ]);
    }
                    ...
                    Step::make('ID Verification')
                        ...
                        ->schema([
                            Section::make('Identity Verification')
                                ->description('Upload your identification documents. This helps build trust with potential tenants.')
                                ->schema([
                                    ...
                                    FileUpload::make('id_document')
                                        ->label('Government ID (NIN Card, Driver\'s License, Passport)')
                                        ->required()
    ...
    public function save(): void
    {
        ...
        $propertyOwner->update([
            ...
            'profile_photo' => collect($data['profile_photo'] ?? [])->first(),
            'id_document' => collect($data['id_document'] ?? [])->first(),
            'proof_of_address' => collect($data['proof_of_address'] ?? [])->first(),
        ...
        $this->redirect(route('filament.property-owner.pages.dashboard'));
    }
