...
use App\Filament\PropertyOwner\Resources\LeaseResource\Pages\ListLeases;
use App\Filament\PropertyOwner\Resources\LeaseResource\Pages\CreateLease;
use App\Filament\PropertyOwner\Resources\LeaseResource\Pages\ViewLease;
use App\Filament\PropertyOwner\Resources\LeaseResource\Pages\EditLease;
use App\Filament\PropertyOwner\Resources\LeaseResource\Pages;
                            ...
                            ->schema([
                                ...
                                Actions::make([
                                    Action::make('manageTemplates')
                                        ...
                                        ->color('gray')
                                        ->url(route('filament.property-owner.resources.lease-templates.index'))
                                        ->openUrlInNewTab(),
                                ])
                                    ->alignEnd(),
                            ]),
