...
namespace App\Filament\PropertyOwner\Resources\PropertyOwnerResource\Pages;

use Filament\Actions\Action;
use Filament\Notifications\Notification;
use App\Filament\PropertyOwner\Resources\PropertyOwnerResource;
    ...
    protected function getHeaderActions(): array
    {
        return [
            Action::make('view_properties')
                ...
                ->url(fn () => route('filament.property-owner.resources.properties.index'))
                ->color('info'),
