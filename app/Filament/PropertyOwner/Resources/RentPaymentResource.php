...
namespace App\Filament\PropertyOwner\Resources;
...
use App\Filament\PropertyOwner\Resources\RentPaymentResource\Pages\ListRentPayments;
use App\Filament\PropertyOwner\Resources\RentPaymentResource\Pages\CreateRentPayment;
use App\Filament\PropertyOwner\Resources\RentPaymentResource\Pages\EditRentPayment;
use App\Filament\PropertyOwner\Resources\RentPaymentResource\Pages\ViewReceipt;
use App\Filament\PropertyOwner\Resources\RentPaymentResource\Pages;
use App\Filament\PropertyOwner\Resources\RentPaymentResource\RelationManagers;
            ...
            ->recordActions([
                ActionGroup::make([
                    ...
                    Action::make('viewReceipt')
                        ...
                        ->color('primary')
                        ->url(fn (RentPayment $record) => route('filament.property-owner.resources.rent-payments.view-receipt', $record))
                    ...
                    Action::make('downloadReceipt')
                        ...
                        ->action(function (RentPayment $record) {
                            return redirect()->to(route('filament.property-owner.resources.rent-payments.view-receipt', $record))->with('auto_download', 'pdf');
                        })
                        ->visible(fn (RentPayment $record) => in_array($record->status, ['paid', 'partial'])),
                    DeleteAction::make(),
                ])
