...
class ViewReceipt extends Page
{
    ...
    protected string $view = 'filament.property-owner.resources.rent-payment-resource.pages.view-receipt';
    ...
    {
        $this->receipt = RentPayment::findOrFail($record);
        
        // Ensure the user owns this payment record
        if ($this->receipt->landlord_id !== Auth::id()) {
    ...
    public function downloadPdf()
    {
        try {
            ...
            try {
                ...
                $pdf = Pdf::view('filament.property-owner.pages.rent-receipt-pdf', [
    ...
    public function downloadPng()
    {
        try {
            ...
            ';
                ...
                $html = view('filament.property-owner.pages.rent-receipt-pdf', [
                    'receipt' => $this->receipt,
                    'qrCode' => $qrCodeSvg,
                    'amountInWords' => $this->amountInWords,
                    'companyLogo' => $companyLogo,
