...
use App\Filament\PropertyOwner\Resources\SalesAgreementResource\Pages\CreateSalesAgreement;
use App\Filament\PropertyOwner\Resources\SalesAgreementResource\Pages\EditSalesAgreement;
use App\Filament\PropertyOwner\Resources\SalesAgreementResource\Pages\ListSalesAgreements;
use App\Filament\PropertyOwner\Resources\SalesAgreementResource\Pages\ViewSalesAgreement;
                        ...
                        Grid::make(2)
                            ->schema([
                                Select::make('template_id')
                                    ->label('Use Template')
                                    ->options(function () {
                                        return SalesAgreementTemplate::where('landlord_id', Auth::id())
                                ...
                                Actions::make([
                                    Action::make('manageTemplates')
                                        ...
                                        ->color('gray')
                                        ->url(route('filament.property-owner.resources.sales-agreement-templates.index'))
                                        ->openUrlInNewTab(),
                                ])
                                    ->alignEnd(),
                            ]),
                                ...
                                Select::make('property_id')
                                    ...
                                    ->relationship('property', 'title', function (Builder $query) {
                                        return $query
                                            ...
                                            ->whereHas('owner', function (Builder $ownerQuery) {
                                                $ownerQuery->where('user_id', Auth::id());
                                            });
                                    })
                                    ->required()
                                    ->searchable()
