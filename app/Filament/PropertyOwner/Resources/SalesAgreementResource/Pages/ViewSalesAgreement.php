...
class ViewSalesAgreement extends ViewRecord
{
    ...
    protected string $view = 'filament.property-owner.pages.sales-agreement-view';
    ...
    public function mount($record): void
    {
        ...
        $defaultTemplate = SalesAgreementTemplate::getDefaultTemplate(Auth::id());
        $this->data = [
    ...
    public function downloadPdf()
    {
        if (! $this->salesAgreementDocument) {
            Log::warning('Sales agreement download requested with no document (landlord).', [
        ...
        try {
            Log::info('Sales agreement download started (landlord).', [
                'agreement_id' => $this->record?->id,
                'user_id' => auth()->id(),
            ...
            Log::info('Sales agreement PDF generated (landlord).', [
