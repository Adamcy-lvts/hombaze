...
class RecentPaymentsWidget extends BaseWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->recordActions([
                Action::make('view')
                    ->url(fn (RentPayment $record): string => route('filament.property-owner.resources.rent-payments.view-receipt', ['record' => $record]))
                    ->icon('heroicon-m-eye'),
                ...
                Action::make('downloadReceipt')
                    ...
                    ->color('success')
                    ->url(fn (RentPayment $record) => route('filament.property-owner.resources.rent-payments.view-receipt', ['record' => $record]) . '?download=png')
