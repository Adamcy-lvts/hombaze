...
if (!function_exists('resolveChromePath')) {
    /**
     * Resolve an executable Chrome/Chromium path for Browsershot.
     *
     * @return string|null
     */
...
if (!function_exists('resolveBrowsershotTempDir')) {
    /**
     * Resolve a stable, writable temp directory for Browsershot.
     *
     * @return string
     */
    function resolveBrowsershotTempDir()
    {
