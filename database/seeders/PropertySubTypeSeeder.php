...
{
    /**
     * Run the property subtype seeds (extracted).
     */
    public function run(): void
    {
        $this->command->info('Seeding Property Subtypes (extracted seeder)...');

        // Validate prerequisites
        $propertyTypeCount = PropertyType::count();
        if ($propertyTypeCount === 0) {
            throw new \Exception('No property types found. Please run the property types seeder first.');
        }
