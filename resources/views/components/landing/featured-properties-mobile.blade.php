...
<section class="block md:hidden relative py-12 bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden" x-data="mobilePropertiesComponent()">
    <!-- Premium Background Elements -->
    <div class="absolute inset-0">
        <!-- Gradient Overlay -->
        <div class="absolute inset-0 bg-linear-to-br from-emerald-900/20 via-transparent to-blue-900/20"></div>
        <!-- Floating Elements -->
        <div class="absolute top-10 right-4 w-20 h-20 bg-linear-to-br from-emerald-400/30 to-teal-500/20 rounded-full blur-2xl"></div>
        <div class="absolute bottom-20 left-4 w-16 h-16 bg-linear-to-br from-blue-400/25 to-indigo-500/15 rounded-full blur-xl"></div>
    </div>
    ...
    <div class="relative z-10 px-4">
        ...
        <div class="text-center mb-8">
            ...
            <h2 class="text-2xl font-black text-white mb-3">
                Featured
                <span class="bg-linear-to-r from-emerald-400 to-blue-400 bg-clip-text text-transparent">Homes</span>
            </h2>
            ...
            <div class="group relative bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 overflow-hidden shadow-2xl"
                ...
                <div class="relative h-48 overflow-hidden">
                    ...
                    <div class="absolute top-3 left-3">
                        <span class="inline-flex items-center space-x-1 bg-emerald-500/90 backdrop-blur-xs text-white px-3 py-1 rounded-lg text-xs font-bold">
                    ...
                    <div class="absolute top-3 right-3">
                        <span class="inline-flex items-center space-x-1 bg-blue-500/90 backdrop-blur-xs text-white px-2 py-1 rounded-lg text-xs font-bold">
                            <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="p-4">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button class="group flex items-center justify-center space-x-2 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 shadow-lg">
