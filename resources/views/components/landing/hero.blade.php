...
<section class="relative min-h-screen overflow-hidden bg-linear-to-br from-slate-900 via-slate-800 to-slate-900" id="hero" x-data="heroComponent()">
    ...
    <div class="absolute inset-0">
        ...
        <div class="absolute inset-0 bg-linear-to-r from-slate-900/90 via-slate-900/70 to-slate-800/60"></div>
        <div class="absolute inset-0 bg-linear-to-t from-slate-900/80 via-transparent to-slate-900/20"></div>
        <div class="absolute inset-0 bg-linear-to-br from-emerald-900/20 via-transparent to-blue-900/20"></div>
    </div>

    <!-- Animated Geometric Elements -->
    <div class="absolute inset-0 opacity-30">
        <!-- Large Floating Orbs -->
        <div class="floating-element absolute top-1/4 right-1/4 w-40 h-40 bg-linear-to-br from-emerald-400/40 to-teal-500/30 rounded-full blur-3xl"></div>
        <div class="floating-element absolute bottom-1/3 left-1/4 w-56 h-56 bg-linear-to-br from-blue-400/25 to-indigo-500/20 rounded-full blur-3xl"></div>
        <div class="floating-element absolute top-1/2 right-1/3 w-32 h-32 bg-linear-to-br from-amber-400/30 to-orange-500/25 rounded-full blur-2xl"></div>
        
        <!-- Small Accent Dots -->
        <div class="floating-element absolute top-1/3 left-1/2 w-4 h-4 bg-emerald-400/60 rounded-full blur-xs"></div>
        <div class="floating-element absolute bottom-1/4 right-1/2 w-6 h-6 bg-blue-400/50 rounded-full blur-xs"></div>
        <div class="floating-element absolute top-3/4 left-1/3 w-3 h-3 bg-amber-400/70 rounded-full blur-xs"></div>
    </div>

    <!-- Premium Mesh Gradient -->
    <div class="absolute inset-0 opacity-10">
        <div class="absolute top-0 left-0 w-96 h-96 bg-linear-to-br from-emerald-400 to-transparent rounded-full blur-3xl"></div>
        <div class="absolute bottom-0 right-0 w-96 h-96 bg-linear-to-tl from-blue-400 to-transparent rounded-full blur-3xl"></div>
    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="premium-badge inline-flex items-center px-4 py-2 md:px-8 md:py-4 bg-white/5 backdrop-blur-xl rounded-xl md:rounded-2xl border border-white/10 shadow-2xl mb-6 md:mb-12 group hover:bg-white/10 transition-all duration-500">
                <div class="flex items-center space-x-2 md:space-x-3">
                    <div class="w-4 h-4 md:w-6 md:h-6 bg-linear-to-r from-yellow-400 to-amber-500 rounded-full flex items-center justify-center">
                ...
                <h1 class="hero-title relative">
                    ...
                    <div class="space-y-2 md:space-y-4">
                        <div class="flex items-center justify-center space-x-3 md:space-x-6">
                            ...
                            <div class="relative">
                                <span class="bg-linear-to-r from-emerald-400 via-teal-300 to-blue-400 bg-clip-text text-transparent text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black tracking-tight leading-none">
                                    Perfect
                                </span>
                                <!-- Animated underline -->
                                <div class="absolute -bottom-1 md:-bottom-2 left-0 right-0 h-0.5 md:h-1 bg-linear-to-r from-emerald-400 to-blue-400 rounded-full transform scale-x-0 animate-pulse"></div>
                            </div>
                        </div>
                        <div class="flex items-center justify-center space-x-3 md:space-x-6">
                            ...
                            <div class="relative">
                                <span class="bg-linear-to-r from-white via-slate-100 to-slate-300 bg-clip-text text-transparent text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-black tracking-tight">
                                    Today
                                </span>
                                <!-- Sparkle effect -->
                                <div class="absolute -top-2 -right-2 md:-top-3 md:-right-3 w-3 h-3 md:w-6 md:h-6 bg-linear-to-r from-yellow-400 to-amber-500 rounded-full opacity-75 animate-ping"></div>
                            </div>
                        </div>
                    </div>
                </h1>
            ...
            <div class="search-container mb-6 md:mb-8" x-data="smartSearch()">
                <div class="max-w-6xl mx-auto relative">
                    <!-- Clean Search Bar -->
                    <div class="premium-search-bar bg-white/5 backdrop-blur-2xl rounded-3xl md:rounded-4xl shadow-2xl border border-white/20 overflow-hidden">
                        <form @submit.prevent="handleSearch" @click.stop class="p-2 md:p-3" data-search-type="enhanced" method="GET" action="/properties">
                            <div class="flex items-center bg-white/10 backdrop-blur-xs rounded-2xl md:rounded-3xl border border-white/10 transition-all duration-300 hover:border-white/20 focus-within:border-emerald-500/50 focus-within:ring-4 focus-within:ring-emerald-500/20"
                                :class="{ 'border-emerald-500/50 ring-4 ring-emerald-500/20': showSuggestions }">
                                
                                <!-- Smart Search Icon -->
                                <div class="shrink-0 pl-4 md:pl-6 pr-3 md:pr-4">
                                ...
                                <div class="flex-1 relative">
                                    <input type="text" 
                                           ...
                                           class="w-full py-4 md:py-5 bg-transparent text-base md:text-xl text-white font-medium placeholder-white/70 focus:outline-hidden border-0 ring-0 pr-4">
                                </div>
                                
                                <!-- Search Button -->
                                <div class="shrink-0 p-1 md:p-2">
                                    <button type="submit"
                                            :disabled="isLoading"
                                        ...
                                        <!-- Hover overlay -->
                                        <div class="absolute inset-0 bg-linear-to-r from-white/20 to-white/10 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
                        ...
                        <div class="p-2 md:p-4">
                            <template x-for="(suggestion, index) in suggestions" :key="index">
                                <div @click="selectSuggestion(suggestion)"
                                    ...
                                    <!-- Suggestion Icon -->
                                    <div class="shrink-0 mr-3 md:mr-4">
            ...
            <div class="flex flex-col sm:flex-row gap-4 md:gap-8 justify-center hero-buttons mb-12 md:mb-20">
                <!-- Primary CTA -->
                <button class="group relative inline-flex items-center px-6 py-3 md:px-12 md:py-6 bg-linear-to-r from-emerald-600 via-emerald-500 to-teal-500 text-white font-bold text-sm md:text-xl rounded-xl md:rounded-2xl overflow-hidden shadow-2xl hover:shadow-emerald-500/40 transition-all duration-500 transform hover:scale-105">
                    <div class="absolute inset-0 bg-linear-to-r from-emerald-700 via-emerald-600 to-teal-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
                ...
                <button class="group relative inline-flex items-center px-6 py-3 md:px-12 md:py-6 bg-white/5 backdrop-blur-xl text-white font-semibold text-sm md:text-xl rounded-xl md:rounded-2xl border-2 border-white/20 hover:bg-white/10 hover:border-white/30 transition-all duration-500 overflow-hidden shadow-xl hover:shadow-2xl transform hover:scale-105">
                    <div class="absolute inset-0 bg-linear-to-r from-white/10 to-white/5 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
                    <span class="relative z-10 flex items-center">
                        <div class="w-6 h-6 md:w-10 md:h-10 bg-linear-to-r from-blue-500 to-indigo-500 rounded-full flex items-center justify-center mr-2 md:mr-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="trust-signals mb-8 md:mb-20">
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-8 lg:gap-16">
                    <div class="group text-center p-4 md:p-6 bg-white/5 backdrop-blur-xs rounded-xl md:rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 w-full sm:w-auto">
                        ...
                        <div class="w-full h-0.5 md:h-1 bg-linear-to-r from-emerald-400 to-teal-500 rounded-full mt-2 md:mt-3 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                    </div>
                    <div class="group text-center p-4 md:p-6 bg-white/5 backdrop-blur-xs rounded-xl md:rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 w-full sm:w-auto">
                        ...
                        <div class="w-full h-0.5 md:h-1 bg-linear-to-r from-blue-400 to-indigo-500 rounded-full mt-2 md:mt-3 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                    </div>
                    <div class="group text-center p-4 md:p-6 bg-white/5 backdrop-blur-xs rounded-xl md:rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105 w-full sm:w-auto">
                        ...
                        <div class="w-full h-0.5 md:h-1 bg-linear-to-r from-amber-400 to-orange-500 rounded-full mt-2 md:mt-3 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500"></div>
                    </div>
                </div>
