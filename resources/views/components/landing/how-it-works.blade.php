...
<section class="relative py-16 lg:py-24 bg-gradient-to-br from-gray-50 via-white to-gray-100 overflow-hidden" x-data="howItWorksComponent()">
    <!-- Background Pattern -->
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12 lg:mb-16">
            ...
            <h2 class="text-3xl lg:text-5xl font-black text-gray-900 mb-4 lg:mb-6">
                How HomeBaze
                <span class="bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent">Works</span>
            </h2>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 mb-16 lg:mb-20">
            <a href="#property-verification" class="group text-center p-4 lg:p-6 bg-white rounded-xl lg:rounded-2xl shadow-md border border-gray-200/60 hover:shadow-lg hover:border-emerald-200 transition-all duration-500"
                ...
                <div class="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-xl flex items-center justify-center mx-auto mb-3 lg:mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <a href="#agent-verification" class="group text-center p-4 lg:p-6 bg-white rounded-xl lg:rounded-2xl shadow-md border border-gray-200/60 hover:shadow-lg hover:border-blue-200 transition-all duration-500"
                 x-intersect.once="$el.classList.add('animate-fade-in-up')">
                <div class="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl flex items-center justify-center mx-auto mb-3 lg:mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="group text-center p-4 lg:p-6 bg-white rounded-xl lg:rounded-2xl shadow-md border border-gray-200/60 hover:shadow-lg hover:border-amber-200 transition-all duration-500"
                 x-intersect.once="$el.classList.add('animate-fade-in-up')">
                <div class="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-amber-100 to-amber-200 rounded-xl flex items-center justify-center mx-auto mb-3 lg:mb-4 group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="group text-center p-4 lg:p-6 bg-white rounded-xl lg:rounded-2xl shadow-md border border-gray-200/60 hover:shadow-lg hover:border-purple-200 transition-all duration-500"
                 x-intersect.once="$el.classList.add('animate-fade-in-up')">
                <div class="w-12 h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl flex items-center justify-center mx-auto mb-3 lg:mb-4 group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="relative mb-16 lg:mb-20">
            ...
            <div class="hidden md:block absolute top-12 left-1/2 transform -translate-x-1/2 w-2/3 h-0.5 bg-gradient-to-r from-emerald-300 via-blue-300 to-purple-300 z-0"></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 relative z-10">
                ...
                <div class="group text-center"
                    ...
                    <div class="relative mb-8">
                        <!-- Step Number -->
                        <div class="absolute -top-4 -left-4 w-8 h-8 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-full flex items-center justify-center shadow-lg z-20">
                            <span class="text-white text-sm font-bold">1</span>
                        </div>
                        <!-- Icon Container -->
                        <div class="w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-500 shadow-lg border-4 border-white relative z-20">
                ...
                <div class="group text-center"
                    ...
                    <div class="relative mb-8">
                        <!-- Step Number -->
                        <div class="absolute -top-4 -left-4 w-8 h-8 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center shadow-lg z-20">
                            <span class="text-white text-sm font-bold">2</span>
                        </div>
                        <!-- Icon Container -->
                        <div class="w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-500 shadow-lg border-4 border-white relative z-20">
                ...
                <div class="group text-center"
                    ...
                    <div class="relative mb-8">
                        <!-- Step Number -->
                        <div class="absolute -top-4 -left-4 w-8 h-8 bg-gradient-to-br from-purple-500 to-purple-600 rounded-full flex items-center justify-center shadow-lg z-20">
                            <span class="text-white text-sm font-bold">3</span>
                        </div>
                        <!-- Icon Container -->
                        <div class="w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-all duration-500 shadow-lg border-4 border-white relative z-20">
        ...
        <!-- Key Benefits -->
        <div class="bg-gradient-to-br from-slate-50 to-white rounded-3xl p-8 lg:p-12 shadow-xl border border-gray-200/60">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                <div class="group flex items-start space-x-4 p-4 lg:p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
                     x-intersect.once="$el.classList.add('animate-fade-in-up')">
                    <div class="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-green-100 to-green-200 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="group flex items-start space-x-4 p-4 lg:p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
                     x-intersect.once="$el.classList.add('animate-fade-in-up')">
                    <div class="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="group flex items-start space-x-4 p-4 lg:p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300"
                     x-intersect.once="$el.classList.add('animate-fade-in-up')">
                    <div class="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                    <a href="{{ route('properties.search') }}" 
                       class="group inline-flex items-center justify-center space-x-2 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
