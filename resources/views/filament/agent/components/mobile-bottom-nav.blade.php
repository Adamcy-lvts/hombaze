    ...
    @php
        $items = [
            ...
            [
                ...
                'url' => route('filament.agent.pages.inquiries'),
                'active' => request()->routeIs('filament.agent.pages.inquiries') || request()->routeIs('filament.agent.resources.property-inquiries.*'),
            ],
            [
                'label' => 'Invites',
                'icon' => 'heroicon-o-paper-airplane',
                'activeIcon' => 'heroicon-s-paper-airplane',
                'url' => route('filament.agent.pages.invite-tenant'),
                'active' => request()->routeIs('filament.agent.pages.invite-tenant'),
            ],
        ];
    @endphp
