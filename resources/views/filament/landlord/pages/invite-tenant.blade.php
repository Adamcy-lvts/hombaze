            ...
            <div class="text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pt-8">
                ...
                <div class="space-y-3">
                    @php
                        ...
                        $whatsappMessage = "Hi! $landlordName has invited you register as his tenant for $propertyDetails. on hombaze platform, the best place to buy and sell or rent your property house, land etc.. Click here: $generatedLink";
                    @endphp
