    ...
    >
        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="flex items-center justify-between mb-6">
                <a href="{{ route('filament.property-owner.pages.tenants-list') }}" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 flex items-center">
