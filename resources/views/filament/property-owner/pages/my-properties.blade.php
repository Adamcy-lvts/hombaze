    ...
    <div class="space-y-6 pb-20"> <!-- Padding for bottom nav -->
        ...
        @if($properties->isEmpty())
            <div class="flex flex-col items-center justify-center py-20 text-center space-y-4">
                ...
                <a href="{{ route('filament.property-owner.pages.create-property') }}" class="px-6 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg font-medium transition-colors">
                    Add Property
                </a>
            </div>
        @else
                    ...
                    <div class="rounded-2xl shadow-sm border overflow-hidden flex flex-col
                        ...
                        <div class="p-4 flex-1 flex flex-col bg-white dark:bg-gray-800">
                            ...
                            <div class="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
                                <!-- Edit Link -->
                                <a href="{{ route('filament.property-owner.pages.edit-property', ['record' => $property->id]) }}" 
