{{-- Tenant Rent Receipt View - Identical to Landlord's --}}
<x-filament::page>
    <div>
        ...
        <div id="receipt-container"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 items-center mb-6 relative z-10">
                ...
                <div class="flex items-center space-x-4">
                    <img src="{{ asset('img/homebaze_logo.png') }}" alt="HomeBaze Logo" class="w-20 drop-shadow-md">
                    <div>
                        <h2 class="text-lg font-bold text-gray-800">HomeBaze Property</h2>
                ...
                <div class="text-center text-gray-600 text-sm">
                    <p class="font-semibold">support@homebaze.com</p>
                    <p>www.homebaze.com</p>
                    <p class="text-xs">Property Management Solutions</p>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-end">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-center">
                        <div class="bg-white p-1 rounded shadow-sm border border-gray-200 mb-2 inline-block">
                            @php
                            ...
                            @if($qrCode)
                                {!! $qrCode !!}
                            @else
                                <svg width="80" height="80" viewBox="0 0 60 60" class="border">
                                    ...
                                    <text x="30" y="35" text-anchor="middle" font-size="4" fill="black">QR</text>
                                </svg>
                            @endif
                        </div>
                        <p class="text-xs text-gray-500">Scan for verification</p>
                    </div>

                    <!-- Signature -->
                    <div class="text-center">
                        <div class="w-48 border-b-2 border-gray-400 mb-2"></div>
                        <p class="font-semibold text-gray-700">Landlord Signature</p>
                        <p class="text-xs text-gray-500">{{ $receipt->landlord->name ?? 'Property Owner' }}</p>
                    </div>
                </div>
            </div>
