<div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl lg:text-3xl font-semibold text-gray-900 mb-2">
                    About <span class="text-emerald-600">HomeBaze</span>
                </h1>
    ...
    <section class="py-6 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-semibold text-gray-900 mb-2">Our Core Values</h2>
                    <p class="text-gray-600 max-w-2xl mx-auto">The principles that guide everything we do at HomeBaze</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="text-center bg-white border border-gray-200 rounded-xl p-4 shadow-xs">
                        ...
                        <h4 class="text-lg font-semibold text-gray-900 mb-2">Trust</h4>
                    ...
                    <div class="text-center bg-white border border-gray-200 rounded-xl p-4 shadow-xs">
                        ...
                        <h4 class="text-lg font-semibold text-gray-900 mb-2">Excellence</h4>
                    ...
                    <div class="text-center bg-white border border-gray-200 rounded-xl p-4 shadow-xs">
                        ...
                        <h4 class="text-lg font-semibold text-gray-900 mb-2">Empowerment</h4>
