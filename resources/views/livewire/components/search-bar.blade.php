    ...
    @else
        ...
        <div class="relative flex items-center bg-white/10 backdrop-blur-xl border border-white/20 rounded-full p-1.5 shadow-2xl transition-all duration-300 hover:bg-white/15 ring-1 ring-white/30">
            ...
            <button
                wire:click="search"
                type="button"
                class="inline-flex items-center justify-center bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-400 hover:to-emerald-500 text-white rounded-full font-bold shadow-lg hover:shadow-emerald-500/20 transform hover:-translate-y-0.5 transition-all duration-200
                       px-4 py-3 sm:px-8 sm:py-3 shrink-0 min-w-[48px] sm:min-w-0"
            >
