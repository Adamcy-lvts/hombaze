<div class="min-h-screen bg-linear-to-br from-slate-50 via-blue-50/30 to-indigo-50/20">
    <div class="w-full max-w-7xl mx-auto">
        ...
        <div class="relative overflow-hidden bg-white/80 backdrop-blur-xl border-b border-white/20 shadow-xs">
            <div class="absolute inset-0 bg-linear-to-r from-blue-600/5 via-purple-600/5 to-cyan-600/5"></div>
            <div class="relative px-3 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
                <div class="flex flex-col space-y-4 sm:space-y-6 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
                    <div class="space-y-1 sm:space-y-2">
                        <h1 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-linear-to-r from-gray-900 via-blue-800 to-purple-800 bg-clip-text text-transparent leading-tight">
                            My Searches
                        </h1>
        ...
        @if (session()->has('success'))
            <div class="mx-3 mt-4 p-4 sm:mx-6 sm:mt-6 sm:p-5 bg-linear-to-r from-emerald-50 to-green-50 border border-emerald-200/60 rounded-xl sm:rounded-2xl shadow-xs">
        ...
        @if($recentlyCreatedSearchId && $searchJobStatus === 'searching')
            <div class="mx-3 mt-4 p-4 sm:mx-6 sm:mt-6 sm:p-6 bg-linear-to-r from-blue-50 to-indigo-50 border border-blue-200/60 rounded-xl sm:rounded-2xl shadow-xs"
        ...
        @if($searches->count() > 0)
            <div class="px-3 py-4 space-y-4 sm:px-6 sm:py-6 sm:space-y-6">
                @foreach($searches as $search)
                    <div class="group bg-white/80 backdrop-blur-xs rounded-xl sm:rounded-2xl shadow-xs border border-gray-100/60 overflow-hidden hover:shadow-xl hover:shadow-gray-200/40 transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="p-4 sm:p-6 border-b border-gray-100/60">
                            ...
                            <div class="flex items-center justify-between mb-3 sm:mb-4">
                                <div class="flex items-center space-x-2">
                                    <div class="relative">
                                        <div class="p-1 bg-linear-to-br from-blue-50 to-indigo-50 rounded-lg group-hover:from-blue-100 group-hover:to-indigo-100 transition-colors duration-300">
                            ...
                            <div>
                                    ...
                                    <div class="flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4">
                                        @if($search->is_default)
                                            <span class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1.5 rounded-full text-xs font-semibold bg-linear-to-r from-amber-100 to-yellow-100 text-amber-800 shadow-xs">
                                                <x-heroicon-o-star class="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1 sm:mr-1.5" />
                                                Default
                                            </span>
                                        @endif
                                        @if($search->has_matches)
                                            <span class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1.5 rounded-full text-xs font-semibold bg-linear-to-r from-emerald-100 to-green-100 text-emerald-800 shadow-xs">
                                        ...
                                        @endif
                                        <span class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1.5 rounded-full text-xs font-semibold {{ $search->is_active ? 'bg-linear-to-r from-emerald-100 to-green-100 text-emerald-800' : 'bg-linear-to-r from-gray-100 to-slate-100 text-slate-600' }} shadow-xs">
                                    ...
                                    <div class="space-y-2 sm:grid sm:grid-cols-1 md:grid-cols-3 sm:gap-3 sm:space-y-0 mb-3 sm:mb-4">
                                        <div class="flex items-center space-x-2 sm:space-x-3 p-2.5 sm:p-3 bg-linear-to-r from-blue-50/50 to-cyan-50/50 rounded-lg sm:rounded-xl border border-blue-100/50">
                                            <div class="p-1 sm:p-1.5 bg-blue-100 rounded-sm">
                                        ...
                                        <div class="flex items-center space-x-2 sm:space-x-3 p-2.5 sm:p-3 bg-linear-to-r from-emerald-50/50 to-green-50/50 rounded-lg sm:rounded-xl border border-emerald-100/50">
                                            <div class="p-1 sm:p-1.5 bg-emerald-100 rounded-sm">
                                        ...
                                        <div class="flex items-center space-x-2 sm:space-x-3 p-2.5 sm:p-3 bg-linear-to-r from-purple-50/50 to-pink-50/50 rounded-lg sm:rounded-xl border border-purple-100/50">
                                            <div class="p-1 sm:p-1.5 bg-purple-100 rounded-sm">
                                    ...
                                    <div class="flex items-center text-xs text-slate-500 bg-slate-50/50 rounded-lg px-2.5 py-1.5 sm:px-3 sm:py-2">
                                        <x-heroicon-o-clock class="w-3 h-3 sm:w-3.5 sm:h-3.5 mr-1.5 sm:mr-2 shrink-0" />
                        ...
                        @if($search->has_matches)
                            <div class="relative overflow-hidden bg-linear-to-r from-emerald-50/80 via-green-50/60 to-teal-50/80 border-b border-emerald-100/60">
                                <div class="absolute inset-0 bg-linear-to-r from-emerald-500/5 to-green-500/5"></div>
                                <div class="relative p-4 sm:p-6">
                                    <div class="flex items-center justify-between mb-3 sm:mb-4">
                                        <div class="flex items-center space-x-2 sm:space-x-3">
                                            <div class="flex items-center space-x-1.5 sm:space-x-2">
                                                <div class="w-2.5 h-2.5 sm:w-3 sm:h-3 bg-emerald-500 rounded-full animate-pulse shadow-xs"></div>
                                    ...
                                    @if($search->latest_matched_property)
                                        <div class="bg-white/90 backdrop-blur-xs rounded-lg sm:rounded-xl p-3 sm:p-4 border border-emerald-200/60 shadow-xs">
                                            <div class="flex items-start justify-between">
                                                <div class="flex-1 min-w-0 pr-3 sm:pr-4">
                                                    ...
                                                    <div class="space-y-1.5 sm:space-y-2">
                                                        <div class="flex items-center space-x-1.5 sm:space-x-2">
                                                            <div class="p-0.5 sm:p-1 bg-slate-100 rounded-sm">
                                                        ...
                                                        <div class="flex items-center space-x-1.5 sm:space-x-2">
                                                            <div class="p-0.5 sm:p-1 bg-emerald-100 rounded-sm">
                                                ...
                                                <a href="{{ route('property.show', $search->latest_matched_property['slug']) }}"
                                                   class="shrink-0 inline-flex items-center px-3 py-2 sm:px-4 sm:py-2.5 bg-linear-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-green-700 text-white text-xs font-semibold rounded-lg sm:rounded-xl transition-all duration-300 shadow-xs hover:shadow-md transform hover:-translate-y-0.5">
                        ...
                        <div class="bg-linear-to-r from-slate-50/80 to-gray-50/60 px-4 py-3 sm:px-6 sm:py-4">
                            ...
                            <div class="flex flex-col xs:flex-row gap-2 sm:gap-3 mb-3 sm:mb-4">
                                ...
                                <button wire:click="toggleSearchStatus({{ $search->id }})"
                                        class="group flex-1 inline-flex items-center justify-center px-4 py-2.5 sm:px-5 sm:py-2.5 text-xs sm:text-sm font-semibold rounded-lg sm:rounded-xl {{ $search->is_active ? 'bg-linear-to-r from-orange-100 to-amber-100 text-orange-700 hover:from-orange-200 hover:to-amber-200' : 'bg-linear-to-r from-emerald-100 to-green-100 text-emerald-700 hover:from-emerald-200 hover:to-green-200' }} transition-all duration-300 shadow-xs hover:shadow-md">
                                    @if($search->is_active)
                            ...
                            <div class="flex flex-wrap gap-1.5 sm:gap-2">
                                @if(!$search->is_default)
                                    <button wire:click="setDefaultSearch({{ $search->id }})"
                                            class="group inline-flex items-center px-2.5 py-1.5 sm:px-3 sm:py-2 text-xs font-semibold rounded-lg bg-linear-to-r from-amber-100 to-yellow-100 text-amber-700 hover:from-amber-200 hover:to-yellow-200 transition-all duration-300 shadow-xs">
                                ...
                                <a href="{{ route('customer.searches.edit', $search) }}"
                                   class="group inline-flex items-center px-2.5 py-1.5 sm:px-3 sm:py-2 text-xs font-semibold rounded-lg bg-linear-to-r from-blue-100 to-indigo-100 text-blue-700 hover:from-blue-200 hover:to-indigo-200 transition-all duration-300 shadow-xs">
                                ...
                                <button wire:click="deleteSearch({{ $search->id }})"
                                        ...
                                        class="group inline-flex items-center px-2.5 py-1.5 sm:px-3 sm:py-2 text-xs font-semibold rounded-lg bg-linear-to-r from-red-100 to-rose-100 text-red-700 hover:from-red-200 hover:to-rose-200 transition-all duration-300 shadow-xs">
            ...
            @if($searches->hasPages())
                <div class="px-3 py-6 sm:px-6 sm:py-8">
                    <div class="bg-white/60 backdrop-blur-xs rounded-xl p-3 sm:p-4 border border-gray-100/60">
                        {{ $searches->links() }}
                    </div>
                </div>
            @endif
        @else
            ...
            <div class="flex flex-col items-center justify-center px-4 py-16 sm:py-20 text-center">
                <div class="relative mb-6 sm:mb-8">
                    <div class="w-20 h-20 sm:w-24 sm:h-24 bg-linear-to-br from-blue-100 via-indigo-100 to-purple-100 rounded-2xl sm:rounded-3xl flex items-center justify-center shadow-lg">
                        <x-heroicon-o-magnifying-glass class="w-10 h-10 sm:w-12 sm:h-12 text-blue-600" />
                    </div>
                    <div class="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-6 h-6 sm:w-8 sm:h-8 bg-linear-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg">
