                           ...
                           class="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border border-gray-100 flex flex-col h-full">
                            ...
                            <div class="relative h-52 shrink-0 overflow-hidden">
                                ...
                                <div class="absolute top-3 left-3 flex gap-2 z-10">
                                    @php
                                        $isOwnerVerified = ($property->agent && $property->agent->is_verified) || 
                                                           ($property->agency && $property->agency->is_verified) || 
                                                           ($property->owner && $property->owner->is_verified);
                                    @endphp
                                    @if($isOwnerVerified)
                                        <div class="flex items-center space-x-1 bg-white/95 backdrop-blur-sm text-emerald-600 px-2.5 py-1 rounded-md text-xs font-bold shadow-sm">
