<div class="featured-properties-component">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        @forelse($properties as $property)
            <div class="property-card group relative bg-white/80 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:scale-[1.02] hover:-translate-y-1">
                <!-- Premium Glass Overlay -->
                <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent rounded-2xl pointer-events-none"></div>
                
                <!-- Property Image Container -->
                <div class="relative h-56 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden rounded-t-2xl">
                    ...
                    @elseif($property->getFirstMediaUrl('gallery'))
                        <img src="{{ $property->getFirstMediaUrl('gallery') }}" 
                             ...
                             class="property-image w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
                    @else
                        <div class="w-full h-full bg-gradient-to-br from-blue-50 to-emerald-50 flex items-center justify-center">
                    ...
                    <div class="absolute top-4 left-4">
                        <div class="inline-flex items-center px-3 py-1.5 rounded-full bg-white/90 backdrop-blur-sm border border-white/50 shadow-lg">
                    ...
                    <div class="absolute top-4 right-4">
                        <div class="inline-flex items-center px-3 py-1.5 rounded-full bg-gradient-to-r from-emerald-500 to-blue-500 text-white shadow-lg">
                    ...
                    <div class="absolute bottom-4 left-4">
                        <div class="inline-flex items-center px-2 py-1 rounded-full bg-yellow-400/90 backdrop-blur-sm">
                ...
                <div class="p-6 relative">
                    ...
                    <div class="flex items-center text-gray-600 mb-4">
                        <div class="w-5 h-5 rounded-full bg-gradient-to-r from-blue-500 to-emerald-500 flex items-center justify-center mr-2">
                    ...
                    <a href="/property/{{ $property->slug }}" class="group/btn relative w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-emerald-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] overflow-hidden">
                        ...
                        <div class="absolute inset-0 -top-1 -left-1 bg-gradient-to-r from-transparent via-white/30 to-transparent skew-x-12 -translate-x-full group-hover/btn:translate-x-full transition-transform duration-700 rounded-xl"></div>
                    </a>
                </div>

                <!-- Premium hover border effect -->
                <div class="absolute inset-0 rounded-2xl border-2 border-transparent bg-gradient-to-r from-blue-500 to-emerald-500 bg-clip-border opacity-0 group-hover:opacity-100 transition-opacity duration-300" style="padding: 1px;">
        ...
        @empty
            ...
            @for($i = 1; $i <= 6; $i++)
                <div class="property-card group relative bg-white/80 backdrop-blur-sm border border-white/50 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden transform hover:scale-[1.02] hover:-translate-y-1">
                    ...
                    <div class="relative h-56 bg-gradient-to-br from-blue-50 to-emerald-50 overflow-hidden rounded-t-2xl flex items-center justify-center">
                        <svg class="w-16 h-16 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                    ...
                    <div class="p-6 relative">
                        ...
                        <button class="group/btn relative w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-emerald-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] overflow-hidden">
                            <div class="absolute inset-0 bg-white/20 rounded-xl"></div>
                            <span class="relative z-10">View Details</span>
                            <svg class="relative z-10 w-4 h-4 ml-2 transform group-hover/btn:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
